...
def plot_trajectory_components(poses, gt_poses, reproj_error, save_path=None, show_plot=False):
    ...
    axs[0, 0].set_title('X Translation')
    ...
    axs[0, 1].set_title('Y Translation')
    ...
    axs[0, 2].set_title('Z Translation')
    ...
    axs[1, 0].set_title('Yaw Rotation (Degrees)')
    ...
    axs[1, 1].set_title('Pitch Rotation (Degrees)')
    ...
    axs[1, 2].set_title('Roll Rotation (Degrees)')
    axs[1, 2].set_xlabel('Time')
    axs[1, 2].set_ylabel('Roll (deg)')
    axs[1, 2].legend()
    axs[1, 2].grid(True)
